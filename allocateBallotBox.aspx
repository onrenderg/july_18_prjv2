<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="allocateBallotBox.aspx.vb" Inherits="SEC_InventoryMgmt.allocateBallotBox" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
            ...
            <asp:UpdatePanel runat="server" ID="panel1" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="card-body">
                        ...
                        <div class="hide form-group row" id="Div1">
                            <asp:Label ID="lblElectionFor" runat="server" CssClass="col-sm-2 text-md-right" Text="Election Type" meta:resourcekey="electionFor" />
                            <div class="col-sm-5">
                                <asp:RadioButtonList ID="rbPriPost" CssClass="form-control" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbPriPost_SelectedIndexChanged">
                                </asp:RadioButtonList>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row" id="dvBlock" runat="server">
                            <asp:Label ID="lblBlk" runat="server" CssClass="col-sm-2 text-md-right"><%= Resources.Resource.lblMC %></asp:Label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row" id="dvPanch" runat="server">
                            <asp:Label ID="lblPanch" runat="server" class="col-sm-2 text-md-right control-label"><%= Resources.Resource.lblMCWard %></asp:Label>
                            <div class="col-sm-3">
