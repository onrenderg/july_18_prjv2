<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AddNewMaster.aspx.vb" Inherits="SEC_InventoryMgmt.AddNewMaster" %>
                    ...
                    <div id="dvList" runat="server" class="card-body">
                        <form id="Edit_Form" method="post">
                            ...
                            <div class="text-center">
                                <asp:Button ID="submitButton" runat="server" Text="Add Master (मास्टर जोड़ें)" class="btn btn-primary text-center"/>
                            </div>
                        </form>
                    </div>
                </ContentTemplate>
