<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="allocateEVM.aspx.vb" Inherits="SEC_InventoryMgmt.allocateEVM" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
        ...
        <div class="card">
            <asp:UpdatePanel runat="server" ID="panel1" UpdateMode="Conditional">
                    ...
                    <div class="card-body">
                        <div class="form-group row" id="dvPri" runat="server">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-10">
                                <asp:RadioButtonList ID="rbPriPost" CssClass="col-12 select2-container--default" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                                </asp:RadioButtonList>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="dvWard" runat="server" visible="false">
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList ID="ddlConsWard" runat="server" CssClass="form-control" AutoPostBack="true" />
                            </div>
                        </div>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlConsWard" EventName="SelectedIndexChanged" />
