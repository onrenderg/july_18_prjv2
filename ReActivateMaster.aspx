<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ReActivateMaster.aspx.vb" Inherits="SEC_InventoryMgmt.ReActivateMaster" %>
                        ...
                        <form id="Edit_Form" method="post"> 
                            ...
                            <div class="row mb-1">
                                <div class="form-group  col-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <asp:TextBox ID="de_activation_remakrs" runat="server" CssClass="form-control" ReadOnly="true" Enabled="false"/>
                                </div>
                            </div>
