...
Public Class updateStationeryStock
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            MyTable = objCommonFunctions.PopulateStationeryAvailableDataTable(userName, rbUnitType.SelectedValue, rbPriPost.SelectedValue, userName, True)
    ...
    Protected Sub save_button_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles save_button.Click
        ...
        Try
            ...
            mytable = dbconnect.UpdateStationeryStock(tbl_StationeryMapping, dis_code, rbUnitType.SelectedValue, rbPriPost.SelectedValue, userLevel, userName, userName, False, False)
            If mytable.Rows.Count > 0 Then
                If mytable.Rows(0)(0).ToString = "updated" Then
                    ...
                    mytable = objCommonFunctions.PopulateStationeryAvailableDataTable(userName, rbUnitType.SelectedValue, rbPriPost.SelectedValue, dis_code, True)
    ...
    Protected Sub fillgrid_ballot()
        If rbBallotBoxStationery.SelectedIndex <> -1 Then
            Dim MyTable = objCommonFunctions.PopulateStationeryAvailableDataTable(userName, rbUnitType.SelectedValue, rbPriPost.SelectedValue, dis_code, True)
